...
As we can see in figure[figure], the performance slows down linearly in the number of objects in the tree, and exponentially in the number of groups, as expected. The time required to perform a total repartition quickly becomes too big, even with a relatively small tree.
