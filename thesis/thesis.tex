...
\begin{titlepage}
  \centering \itshape
  \vspace*{6em}{
    {\Huge Repartition optimization for \\ distributed B+ trees\par}
  }

  \vspace*{1em}{\Large Master's Thesis}\par
  \today \par

  \vspace*{4em}{\huge Paolo Aurecchia \\
  \small \upshape \url{paolo.aurecchia@usi.ch}}\par

  \vspace*{2em}{\large supervised by \\
  \Large \itshape Paulo Coelho}

  \vspace*{20em}{
  \normalsize \upshape Master of Science in Financial Technology and Computing\\
